...
class appprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // detalle_save
        if ($pathinfo === '/compra/detalles') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_detalle_save;
            }
            return array (  '_controller' => 'Ferreteria\\CompraBundle\\Controller\\CompraController::DetalleAction',  '_route' => 'detalle_save',);
        }
        not_detalle_save:
